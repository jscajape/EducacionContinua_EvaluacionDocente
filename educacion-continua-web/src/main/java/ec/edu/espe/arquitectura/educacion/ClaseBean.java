...
public class ClaseBean extends BaseBean implements Serializable {
    ...
    public String convertir(String codmax) {
        ...
        String sSubCadena = codmax.substring(0, 5);
        String nSubCadena = codmax.substring(5, 7);
    ...
    public void IngresaDatos() {
        this.maximo = this.claseserv.obtenerTodos();
        Integer tamanio = this.maximo.size();
        tamanio--;
        String codmax = convertir(maximo.get(tamanio).getCodigo().getCodClase());
        clasepk.setCodCurso(codcurso);
        clasepk.setCodClase(codmax);
